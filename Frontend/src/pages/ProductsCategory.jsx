            ...
            {SearchCategory && (
                <div className='mt-16 flex flex-col container mx-auto px-4'>
                    <div className='flex flex-col items-end w-max mb-8'>
                        <p className='text-2xl font-medium uppercase md:font-bold'>{SearchCategory.text?.toLowerCase()}</p>
                    ...
                    {filterProducts.length > 0 ? (
                        ...
                        <div className='flex items-center justify-center h-[60vh]' >
                            <p className='text-2xl font-bold text-pretty'>No Products Found In this Category.</p>
                        </div>
                    )}
                </div>
            )}
